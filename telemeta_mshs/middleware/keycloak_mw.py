...
class KeycloakMiddleware(object):
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        if 'HTTP_AUTHORIZATION' not in request.META:
            return JsonResponse({"detail": unicode(NotAuthenticated.default_detail)},
        ...
        if not required_scope and self.default_access == 'DENY':
            return JsonResponse({"detail": unicode(PermissionDenied.default_detail)},
        ...
        try:
            ...
            return JsonResponse({"detail": unicode(AuthenticationFailed.default_detail)},
