...
FRONT_HOST_URL = 'http://app.francoralite.artefacts.coop:8080'
...
KEYCLOAK_CONFIG = {
    ...
    'KEYCLOAK_SERVER_URL': os.getenv(
        'KEYCLOAK_SERVER_URL', 'http://auth.francoralite.artefacts.coop:8080/auth/'),
...
CORS_ORIGIN_WHITELIST = (
    ...
    os.getenv('API_APP_EXTERNAL_URL', 'app.francoralite.artefacts.coop'),
)
...
LOGIN_REDIRECT_URL = "http://app.francoralite.artefacts.coop:8080/"
