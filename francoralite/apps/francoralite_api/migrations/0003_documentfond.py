...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('francoralite_api', '0002_document_documentcollection_documentitem_documentmission'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fond', models.ForeignKey(related_name='related_document', verbose_name='fond', to='francoralite_api.Fond', on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ['fond', 'title'],
